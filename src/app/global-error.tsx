  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Orbitron:wght@700&family=Rajdhani:wght@600&family=Space+Mono&display=swap"
          rel="stylesheet"
        />
      </head>
        ...
        <div style={containerStyle}>
          <div style={cardStyle}>
            ...
            <p style={subtitleStyle}>
              A critical error occurred in the core framework of the NexaSphere
              ecosystem.
            </p>
